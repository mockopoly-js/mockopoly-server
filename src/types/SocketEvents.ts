...
export interface C_RoomCreate   { playerName: string; token: TokenType; character?: string; characterColor?: string }
export interface C_RoomJoin     { roomCode: string; playerName: string; token: TokenType; character?: string; characterColor?: string; reconnectToken?: string }
